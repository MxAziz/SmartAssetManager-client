          ...
          <form onSubmit={handleSubmit} className="card-body ">
            ...
            <div>
              ...
              <input
                ...
                name="dob"
                required
                className="w-full px-4 py-2 border dark:bg-gray-600 dark:border-none dark:py-3 rounded-md "
              />
            </div>
            <div className="form-control mt-6">
              <button className="btn bg-[#6e3261] border-none text-white hover:bg-gray-700">
                SignUp
              </button>
            </div>
          </form>
